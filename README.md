Manifest for Izuma Connect on Linux microPlatform
==============================================

This manifest extends the Linux microPlatform to include Izuma Connect.
Read more at:
...
mkdir build
cd build
repo init -u git@github.com:petedyer11/manifest-mcce.git -m mcce.xml
```
